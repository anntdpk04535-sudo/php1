...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $params = [];
    if (isset($_GET['detail'])) $params[] = "detail=" . urlencode($_GET['detail']);
...
<head>
    ...
    <style>
        ...
        .btn-cancel{background:none;border:none;color:#dc3545;cursor:pointer;padding:0;font-size:14px;text-decoration:underline;margin-left:8px}.btn-cancel:hover{color:#bd2130;text-decoration:none}
    </style>
</head>
<body>
...
<div class="container">
    <div class="list-box">
        ...
        <form method="GET" style="margin-bottom: 15px; display: flex; gap: 10px;">
            <input type="text" name="search" placeholder="Nhập mã đơn hoặc tên khách hàng..." value="<?= htmlspecialchars($search) ?>" style="flex: 1; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
            ...
            <?php if ($search !== ''): ?>
                <a href="DonHang.php" style="padding: 8px 15px; background: #6c757d; color: white; border-radius: 4px; text-decoration: none;">Xóa</a>
            <?php endif; ?>
        </form>
