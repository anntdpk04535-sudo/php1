        ...
        <tbody>
          ...
          foreach ($_SESSION['cart'] as $item):
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <a href="cart.php?remove=<?= urlencode($item['id']) ?>" class="btn-remove" if(confirm('Xóa sản phẩm này khỏi
                  giỏ hàng?')) return true; else return false;" title="Xóa mặt hàng này">
                  <span>🗑️</span> Xóa
                </a>
              </td>
            </tr>
